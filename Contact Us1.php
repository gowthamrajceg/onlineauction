...
<br><br>
<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/profile.jpg" alt="Photo" width="450px" height="400px"></img><br>
<p><a style="background-color:white;height:25px;width:90%;"> <span style="color:black"><font size="5">Gowthamraj</span></a>.</p>
</div>
<br><br>
...
<p><a style="background-color:white;height:25px;width:90%;"> <span style="color:black"><font size="5">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp+9750417833<br></span>
<span style="color:black"><font size="5">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp+8870021648<br></span>
</a>.<a style="background-color:white;height:30px;width:100%;"> </a>.</p>
</div>

<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img  src="Image/Email.png" alt="Photo" width="100px" height="80px" style="align:left"></img>
 <p><a style="background-color:white;height:30px;width:100%;" href="mailto:gowthamrajp06@gmail.com"> <span style="color:black"><font size="5">GOWTHAMRAJ</span></a></font></span></a>.<a style="background-color:white;height:40px;width:100%;" href="mailto:2getdp@gmail.com"> <span style="color:black"><font size="5"><br>DP</span></a></font></span></p>
</div>
      ...
      <form method="POST" name="UserMessage" onsubmit=" return  validmessage();">
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea  name="message" placeholder="Enter Your Comment"></textarea><br />
              </div>
