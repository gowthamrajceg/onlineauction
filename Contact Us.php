...
<nav class="navbar navbar-inverse" data-offset-top="197">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="http://gowthamrajp06.000webhostapp.com/">gowthamraj</a>
    </div>
...
<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/profile.jpg" alt="Photo" width="250px" height="200px"></img><br>
<p><a style="background-color:white;height:30px;width:100%;"> <span style="color:black"><font size="5">Gowthamraj</span></a>.</p>
</div>
...
<p><a style="background-color:white;height:25px;width:90%;"> <span style="color:black"><font size="5">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp+9750417833<br></span></a>.<a style="background-color:white;height:30px;width:100%;"> <span style="color:black"><font size="5">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp+8870021648</span></a>.</p>
</div>

<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img  src="Image/Email.png" alt="Photo" width="100px" height="80px" style="align:left"></img>
 <p><a style="background-color:white;height:30px;width:100%;" href="mailto:gowthamrajp06@gmail.com"> <span style="color:black"><font size="5">Gowthamraj</span></a></font></span></a>.<a style="background-color:white;height:30px;width:100%;" href="mailto:msdselva@gmail.com"> <span style="color:black"><font size="5"><br>Selva</span></a></font></span></p>
</div>


<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/Facebook.png" alt="Photo" width="150px" height="80px"></img><br>
<p><a style="background-color:white;height:30px;width:100%;" href="https://www.facebook.com/gowthamraj.p.5"> <span style="color:black"><font size="5">Gowthamraj</span></font></span></a><a style="background-color:white;height:30px;width:100%;" href="https://www.facebook.com/gowthamraj.p.5"> <span style="color:black"><font size="5"><br>Selva</span></a></p>
</div>


<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/Linkedin.png" alt="Photo" width="150px" height="80px"></img><br>
<p><a style="background-color:white;height:30px;width:100%;" href="https://www.linkedin.com/in/gowtham-raj-022035159/"> <span style="color:black"><font size="5">Gowthamraj</span><a style="background-color:white;height:30px;width:100%;" href="https://www.linkedin.com/in/gowtham-raj-022035159/"> <span style="color:black"><font size="5"><br>DP</span></a></p>
</div>

<div class="Parallel">
&nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/d.jpg" alt="Photo" width="250px" height="200px"></img><br>
<p><a style="background-color:white;height:30px;width:100%;"> <span style="color:black"><font size="5">DP</span></a>.</p>
</div>
<br><br>
